...
class PickleDbCache(Cache):
    def __init__(self, pickledb_load: Callable, file_path: str):
        self.pickledb_load = pickledb_load
        self.file_path = file_path
        self.pickledb = None  # lazy loaded

    def initialize_if_needed(self):
        if self.pickledb == None:
            self.pickledb = self.pickledb_load(self.file_path, False)
